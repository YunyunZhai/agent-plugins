# config-logging Specification

## Purpose

Define how gh-search configures logging through the `logging` section of `config.yaml`, covering log level, file and console output, environment variable overrides, and consistent behavior across the REST service and search/step scripts.
